 ...
 **********************************************************************************/
 ...
 const char* ssid = "123456789";  //WiFi Name
 const char* password = "123456789";  //WiFi Password
 
 // Use @myidbot to find out the chat ID of an individual or a group
 // You need to click "start" on a bot before it can message you 
 // Initialize Telegram BOT
 String chatId = "5358000444";
 String BOTtoken = "6383654484:AAH1X8OfwtUw3yFWNL3NwB1vXYsKP0buwqE";
 ...
 String unlockDoor(){  
  if (lockState == 0) {
   myServo.write(90); // Rotate servo to unlock position (adjust as needed)
   lockState = 1;
   delay(100);
 ...
 String lockDoor(){
  if (lockState == 1) {
   myServo.write(0); // Rotate servo to lock position (adjust as needed)
   lockState = 0;
   delay(100);
 ...
 void setup(){
   ...
   myServo.write(0); // Initialize servo position to lock state
